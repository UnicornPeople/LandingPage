export const APPLY_LINK = "https://forms.gle/fUwUkf6cmVSh9amd8";
export const APPLY_GUIDE_LINK =
  "https://jspiner.notion.site/b00b3e7a944b4d088409f3be9d616649";
export const INTERVIEWER_GUIDE_LINK =
